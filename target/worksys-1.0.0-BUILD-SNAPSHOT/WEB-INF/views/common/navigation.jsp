...
<%-- 	                       	<li>
		                        <a href="#"><i class="fa fa-files-o fa-fw"></i> <s:message code="memu.organ"/><span class="fa arrow"></span></a>
		                         <ul class="nav nav-second-level">
		                            <li>
		                               <a href="/deptMgmt"><s:message code="memu.dept"/></a>
		                             </li>
		                             <li>
		                               <a href="/userMgmt"><s:message code="memu.user"/></a>
		                              </li>
		                         </ul>
		                   </li> --%>
                             <li>
                                 <a href="/commCd/commCdList"><i class="fa fa-gear fa-fw"></i> <s:message code="memu.code"/></a>
                             </li>
	                	</c:if>	        
                    </ul>
                </div>
