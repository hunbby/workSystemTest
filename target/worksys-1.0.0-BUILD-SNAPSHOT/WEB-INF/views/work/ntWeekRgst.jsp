...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<!-- /.row -->
			<div class="row">
				<form id="form1" name="form1" role="form" action="/work/ntWeekWrite" method="post">
					
						<div class="panel panel-default">
						<div class="panel-body">
						
						<div class="row form-group">
							<label class="col-lg-2">차주 코드</label>
								<div class="col-lg-8">
									<input type="text" class="form-control" id="ntWeekCode" name="ntWeekCode" maxlength="255"	value="<c:out value="${list.ntWeekCode}"/>">
								</div>
						</div>
						<div class="row form-group">
						...
						<div class="row form-group">
							<label class="col-lg-2"><s:message code="crud.pjtNm" /></label>
								<div class="col-lg-8">
...
<%-- 						<div class="row form-group">
							<label class="col-lg-2"><s:message code="crud.pjtEp" /></label>
								<div class="col-lg-8">
									<input type="text" class="form-control" id="crtitle"	name="epCode" maxlength="255"		value="<c:out value="${list.epCode}"/>">
								</div>
							</div> --%>
